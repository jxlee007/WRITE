...
- **Jokers** (2) — outside the normal hierarchy; wildcard status; often dangerous precisely because they seem non-threatening (see: [[characters/Clown / Joker of Diamonds]])
...
|-------|-----------|---------------|
| Clubs | Raw power / combat hunger | [[characters/Sato]] — rags to power, insane courage |
...
- **Storm of Changes** — a domain-like power test; [[characters/Sato]] was first mortal to pass
